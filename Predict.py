...
def predict(narrative, clf_product, clf_escalation, tf_idf_vectorizer, scaler):
    ...
    escalation_prob_fig, response = predict_escalation(clf_escalation,
...
def predict_product_type(clf_product, narrative_vectorized):
    product_type_prob = clf_product.predict(narrative_vectorized)[0]
...
def main():
    ...
    product_type, escalation_prob_fig, suggest_response = predict(narrative,
                                                                  clf_product,
                                                                  clf_escalation,
                                                                  tf_idf_vectorizer,
                                                                  scaler)
